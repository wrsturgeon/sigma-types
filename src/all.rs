...
pub struct All<Invariant: crate::Test<Input::Item>, Input: IntoIterator + fmt::Debug>(
...
impl<Invariant: crate::Test<Input::Item>, Input: IntoIterator + fmt::Debug> crate::Test<Input>
...
pub struct NotAll<'i, Item: fmt::Debug, Invariant: crate::Test<Item>> {
...
impl<Item: fmt::Debug, Invariant: crate::Test<Item>> fmt::Display for NotAll<'_, Item, Invariant> {
    #[inline]
